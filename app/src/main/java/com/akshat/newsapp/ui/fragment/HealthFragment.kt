...
import com.akshat.newsapp.databinding.FragmentHealthBinding
    ...
    override fun onCreateView(
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            withContext(Dispatchers.Main){
                ...
                binding?.newsRecycler?.adapter = NewsAdapter(requireContext(),news!!.articles,viewModel!!,this@HealthFragment)
